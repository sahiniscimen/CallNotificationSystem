...
class CallHistoryServiceTest {
    ...
    @Test
    void whenNewCallHistoryArrivedThenShouldBeCreatedSuccesfully(){
        ...
        CallHistory savedCallHistory = callHistoryService.createCallHistory(mockCallHistoryDTO);
    ...
    @Test
    void whenCallHistoryAlreadyExistsArrivedThenShouldBeUpdatedSuccesfully(){
        final CallHistoryDTO mockCallHistoryDTO = new CallHistoryDTO("05002002020","05001001010");
        final LocalDateTime mockLocalDate = LocalDateTime.of(2020,01,14,21,47);;
        final CallHistory mockCallHistory = new CallHistory("05002002020","05001001010", mockLocalDate, 1);
        ...
        CallHistory updatedCallHistory = callHistoryService.createCallHistory(mockCallHistoryDTO);
